package cn.judge.shizai.common.interceptor;
...
import cn.judge.shizai.common.Application;
import cn.judge.shizai.common.session.AuthLocator;
import cn.judge.shizai.common.session.ServletAuthLocator;
...
//    	return false;
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
    	...
    	if (modelAndView != null && request.getUserPrincipal() != null) {
        	modelAndView.addObject("loginName", request.getUserPrincipal().getName());
    	}
        return ;
    }
