package com.elecom.crawler.pilot.batch.reader;
...
public class PmiFlatFileItemReader<T> extends AbstractItemCountingItemStreamItemReader<T>
		implements ResourceAwareItemReaderItemStream<T>, InitializingBean {

	private static final Log logger = LogFactory.getLog(PmiFlatFileItemReader.class);
	...
	public PmiFlatFileItemReader() {
		setName(ClassUtils.getShortName(PmiFlatFileItemReader.class));
	}
